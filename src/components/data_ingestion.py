...
from src.components.model_trainer import ModeltTrainer,ModelTrainerConfig
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df =pd.read_csv('/home/gamerugs/Documents/GitHub/mlproject/src/data/stud.csv')
